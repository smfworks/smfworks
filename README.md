...
| | |
|---|---|
| **What it is** | Sidebar **SMF Apps** plus ⌘K → Open SMF App Launcher. Kit cards show even before clone. |
...
| **Session Timeline** | Paste an agent/chat log → clean shareable vertical timeline card (Receipt’s story twin) | **[session-timeline-sepia.vercel.app](https://session-timeline-sepia.vercel.app)** | [session-timeline](https://github.com/smfworks/session-timeline) |
| **Handoff Slip** | Fill from / to / goal / done / risks / next → shareable agent-to-agent baton slip | **[handoff-slip.vercel.app](https://handoff-slip.vercel.app)** | [handoff-slip](https://github.com/smfworks/handoff-slip) |
...
| [session-timeline](https://github.com/smfworks/session-timeline) | Paste an agent/chat log → clean shareable vertical timeline card. Demo: [session-timeline-sepia.vercel.app](https://session-timeline-sepia.vercel.app) |
| [handoff-slip](https://github.com/smfworks/handoff-slip) | Fill from / to / goal / done / risks / next → shareable agent-to-agent baton slip. Demo: [handoff-slip.vercel.app](https://handoff-slip.vercel.app) |
